...
App({
  ...
  makePhoneCall () {
    console.log(this.globalData.information)
    let phone = this.globalData.information.phone
    wx.makePhoneCall({
      phoneNumber: phone,
  ...
  getLocation () {
    console.log(this.globalData.information.position)
    let position = this.globalData.information.position
